        ...
        case 5:
        {
            ...
            do
            {
                ...
                case 1:
                {
                    ...
                    string cnic = getValidatedCNIC("Enter CNIC (e.g., 12345-1234567-1): ");
                    string phone = getValidatedPhone("Enter Phone: ");
                    int sid = getValidatedInt("Enter Student ID (to visit): ");
                    string date = getValidatedString("Enter Visit Date (YYYY-MM-DD): ");
                    vm.Add(id, name, address, cnic, phone, sid, date);
                    break;
                }
                case 2:
                {
                ...
                case 3:
                {
                    ...
                    string name = getValidatedString("Enter New Visitor Name: ");
                    string address = getValidatedString("Enter New Address: ");
                    string cnic = getValidatedCNIC("Enter New CNIC: ");
                    string phone = getValidatedPhone("Enter New Phone: ");
                    int sid = getValidatedInt("Enter New Student ID: ");
                    string date = getValidatedString("Enter New Visit Date: ");
                    vm.Update(id, name, address, cnic, phone, sid, date);
                    break;
                }
                case 4:
                {
